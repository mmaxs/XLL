...
BOOL XLOper12ToXLOper(LPXLOPER12 pxloper12, LPXLOPER pxloper)
{
	...
	case xltypeStr:
		...
		{
			ast = static_cast< char* >(malloc((cach + 2) * sizeof(char)));
			if (ast == NULL)
			{
				fRet = FALSE;
			}
	...
	case xltypeMulti:
		...
		else
		{
			...
			{
				rgxloperConv = static_cast< LPXLOPER >(malloc(cxloper12 * sizeof(XLOPER)));
...
BOOL XLOperToXLOper12(LPXLOPER pxloper, LPXLOPER12 pxloper12)
{
	...
	case xltypeMulti:
		...
		else
		{
			...
			{
				rgxloper12Conv = static_cast< LPXLOPER12 >(malloc(cxloper * sizeof(XLOPER12)));
